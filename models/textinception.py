...
def inception_v3(pretrained=False, progress=True, **kwargs):
    ...
    return TextInception3(**kwargs)


class TextInception3(nn.Module):

    def __init__(self, num_classes=1000, aux_logits=False, transform_input=False):
        super(TextInception3, self).__init__()
        self.aux_logits = aux_logits
        self.transform_input = transform_input
        self.Conv2d_1a_3x3 = BasicConv2d(1, 32, kernel_size=3, stride=1, padding=1)
